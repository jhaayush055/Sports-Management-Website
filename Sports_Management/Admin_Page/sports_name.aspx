<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Page/Admin_Page.master" AutoEventWireup="true"
    CodeFile="sports_name.aspx.cs" Inherits="Admin_Page_sports_name" %>
                        ...
                        <div class="panel panel-widget agile-validation">
                            <div class="my-div">
                                <div class="valida" autocomplete="off" novalidate="novalidate">
                                    ...
                                    <label for="txtsname">
                                        Sports Name: (required)&nbsp;<span class="at-required-highlight">*</span></label>
                                    <div class="form-group">
                                        <asp:TextBox ID="txtsname" required="true" placeholder="Enter Sports Name" 
                                            class="form-control" runat="server"></asp:TextBox>
                                    </div>
                                    <hr />
                                    <p>
                    ...
                    <div id="table">
                        <asp:GridView ID="dgv" runat="server" OnPageIndexChanging="dgv_PageIndexChanging"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Sports Name">
                                    <ItemTemplate>
                                        <asp:Label ID="lblsname" runat="server" Text='<%#Eval("sports_name") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#partial-1').on('click', function (ev) {
                ...
                $('div').valida('partial', '#txtsname'); // validate only text
            });
        });
    </script>
    <!-- //input-forms -->
