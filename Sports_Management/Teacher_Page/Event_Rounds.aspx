<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher_Page/Teacher_Page.master" AutoEventWireup="true" CodeFile="Event_Rounds.aspx.cs" Inherits="Teacher_Page_Event_Rounds" %>
                    ...
                    <div class="w3agile-validation">
                        <div class="panel panel-widget agile-validation">
                            <div class="my-div">
                                ...
                                <div class="agile-tables">
                                    <div class="w3l-table-info">
                                        <label for="DropDownList2">
                                            Select Round: (required)&nbsp;<span class="at-required-highlight">*</span></label>
                                        <div class="form-group">
                                            ...
                                            <asp:GridView ID="dgv" runat="server" AllowPaging="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Mark Attendance">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblMark_Attendance" runat="server" Text='<%#Eval("Mark_Attendance") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Mark Attendance On">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblMark_Attendance_On" runat="server" Text='<%#Eval("Mark_Attendance_On") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Round In">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblRound_In" runat="server" Text='<%#Eval("Round_In") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Round In On">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblRound_In_On" runat="server" Text='<%#Eval("Round_In_On") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
                                ...
                                <hr />
                                <p>
                                    <asp:Button ID="Add_Round" class="btn btn-primary" runat="server" Text="Add In Round" OnClick="Add_Round_Click" />
                                </p>
                            </div>
                        </div>
                    </div>
